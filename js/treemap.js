...
var margin = {top: 20, right: 0, bottom: 0, left: 650},
    width = 820,
...
/* create grandparent bar at top */
	...
	g.append("rect")
		...
		.append("title")
		.text(function(d) { 
			// console.log(d.name + " " + formatNumber(d.size))
			return d.name + " " + formatNumber(d.size); }); /*should be d.value*/
	...
	g.append("foreignObject")
		...
		.html(function(d) { 
			...
			if (d.value > 0 && typeof(d.value) !== "undefined") {
				console.log(d)
				console.log(d.name + " (" + formatNumber(d.value) + ")")
